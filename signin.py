...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.setStyleSheet("background-color: rgb(191, 187, 186);")
        self.frame = QtWidgets.QFrame(Dialog)
        self.frame.setGeometry(QtCore.QRect(90, 80, 631, 461))
        self.frame.setStyleSheet("background-color: rgb(252, 250, 250);")
        ...
        self.label.setStyleSheet("color: rgb(11, 1, 15);")
        ...
        self.lineEdit.setStyleSheet("background-color: rgb(252, 250, 250);")
        self.lineEdit.setObjectName("lineEdit")
        self.lineEdit_2 = QtWidgets.QLineEdit(self.frame)
        self.lineEdit_2.setGeometry(QtCore.QRect(260, 260, 231, 31))
        self.lineEdit_2.setStyleSheet("background-color:#fcfafa;")
        ...
        self.pushButton.setStyleSheet("background-color: rgb(191, 187, 186);")
        self.pushButton.setObjectName("pushButton")
        self.pushButton_2 = QtWidgets.QPushButton(self.frame)
        self.pushButton_2.setGeometry(QtCore.QRect(220, 360, 101, 41))
        self.pushButton_2.setStyleSheet("background-color:#bfbbba;")
